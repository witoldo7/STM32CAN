...
typedef enum {CAN_47KBPS, CAN_50KBPS, CAN_100KBPS, CAN_125KBPS, CAN_250KBPS, CAN_500KBPS, CAN_600KBPS, CAN_1000KBPS} BITRATE;
...
extern bool CombiSendReplyPacket(packet_t *reply, packet_t *source, uint8_t *data, uint16_t data_len, uint8_t term);
