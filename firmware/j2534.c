...
static j2534_protocol_cfg ISO15765Hs_pcfg = default_config;
static j2534_protocol_cfg ISO15765Sw_pcfg = default_config;
static j2534_protocol_cfg ISO14230_pcfg = default_config;
static j2534_protocol_cfg default_pcfg = default_config;

j2534_conn connCanHs = {
    ...
    .start_filter = (void *)&start_filter_can_common,
    .stop_filter = (void *)&stop_filter_can_common,
    .ioctl_lopback = (void *)ioctl_loopback_can_common,
    .ioctl_datarate = (void *)ioctl_datarate_can_common,
    .ioctl_clear_filters = (void *)ioctl_clear_filters_can_common,
    .ioctl_fast_init = (void *)&ioctl_fast_init_default,
    .ioctl_five_baud_init = (void *)&ioctl_five_baud_init_default,
    .pcfg = &hscan_pcfg};

j2534_conn connCanSw = {
    .connect = (void *)&handle_connect_can,
    .disconnect = (void *)&handle_disconnect_can,
    .read = (void *)&read_message_default,
    .write = (void *)&write_message_can,
...
j2534_conn connISO15765Hs = {
    .connect = (void *)&handle_connect_ISO15765,
    .disconnect = (void *)&handle_disconnect_ISO15765,
    .read = (void *)&read_message_default,
    .write = (void *)&write_message_ISO15765,
    .start_filter = (void *)&start_filter_can_common,
    .stop_filter = (void *)&stop_filter_can_common,
    .ioctl_lopback = (void *)ioctl_loopback_can_common,
    .ioctl_datarate = (void *)ioctl_datarate_can_common,
    ...
    .ioctl_fast_init = (void *)&ioctl_fast_init_default,
    .ioctl_five_baud_init = (void *)&ioctl_five_baud_init_default,
    .pcfg = &ISO15765Hs_pcfg};

j2534_conn connISO15765Sw = {
    .connect = (void *)&handle_connect_ISO15765,
    .disconnect = (void *)&handle_disconnect_ISO15765,
    .read = (void *)&read_message_default,
    .write = (void *)&write_message_ISO15765,
    ...
    .ioctl_fast_init = (void *)&ioctl_fast_init_default,
    .ioctl_five_baud_init = (void *)&ioctl_five_baud_init_default,
    .pcfg = &ISO15765Sw_pcfg};

j2534_conn connISO14230 = {
...
j2534_conn *get_connection(uint32_t channel)
{
  ...
  case SW_CAN_PS:
    return &connCanSw;
  case ISO15765:
    return &connISO15765Hs;
  case SW_ISO15765_PS:
    return &connISO15765Sw;
  case ISO9141:
  case ISO14230:
    return &connISO14230;
  default:
